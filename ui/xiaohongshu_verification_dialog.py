...
class XiaohongshuVerificationDialog(QDialog):
    ...
    def __init__(self, service, url: str, reason: str, parent=None) -> None:
        ...
        self._url = str(url or "https://www.xiaohongshu.com/red_video")
        self._cancel_emitted = False
        self._detached = False
        self.setWindowTitle("小红书安全验证")
        self.resize(1100, 760)
        self.setMinimumSize(800, 560)

        self.status_label = QLabel(str(reason or "小红书需要完成安全验证"))
    ...
    def update_request(self, url: str, reason: str) -> None:
        ...
        self.status_label.setText(str(reason or "小红书需要完成安全验证"))
